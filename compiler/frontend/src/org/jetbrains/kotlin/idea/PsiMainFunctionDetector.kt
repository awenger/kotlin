    ...
    interface Factory {
        ...
        class Ordinary : Factory {
            override fun createMainFunctionDetector(
                trace: BindingTrace,
                languageVersionSettings: LanguageVersionSettings
            ): MainFunctionDetector = PsiMainFunctionDetector(trace.bindingContext, languageVersionSettings)
        }
    }
}
